...
@Mod(modid = SpeedsterHeroesReborn.MODID, name = SpeedsterHeroesReborn.NAME, version = SpeedsterHeroesReborn.VERSION,dependencies = SpeedsterHeroesReborn.REQUIRED, updateJSON = SpeedsterHeroesReborn.UPDATEURL)
public class SpeedsterHeroesReborn
{
    ...
    public static final String REQUIRED = "required-after:revivalcore@[0.3.0,)";
